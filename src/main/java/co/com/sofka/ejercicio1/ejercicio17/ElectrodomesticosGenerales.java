...
public class ElectrodomesticosGenerales {
    ...
    public ElectrodomesticosGenerales(){
    ...
    public ElectrodomesticosGenerales(float precioBase, float peso){
    ...
    public ElectrodomesticosGenerales(float precioBase, float peso, String color, char consumoEnergetico){
        this.precioBase = precioBase;
        this.peso = peso;
